...
3. Under Authentication > Redirect URIs, add a *WEB* type of uri where the redirect points to http://localhost:8080/complete/azuread-tenant-oauth2/  **OR** http://the_hostname_you_have_dojo_deployed:your_server_port/complete/azuread-tenant-oauth2/
.. image:: /_static/google_1.png
